 ...
 */
class activity_organizar_mochila3 : AppCompatActivity() {
    ...
    private val onBackPressedCallback: OnBackPressedCallback = object : OnBackPressedCallback(true) {
        ...
        val siguiente = Intent(this@activity_organizar_mochila3, activity_organizar_mochila2::class.java)
    ...
    fun pasar3(view: View?) {
        val siguiente = Intent(view!!.context, activity_organizar_mochila4::class.java)
        startActivity(siguiente)
    }
